...
export function Tagline() {
  return (
    <div className="w-full my-8 flex flex-col justify-center items-center gap-10">
      ...
      <div className="flex gap-7">
        <Button className="bg-gradient-to-r from-layer to-layerLight w-[180px] py-2 text-[20px] rounded-lg text-second hover:text-highlight duration-100">Join Now</Button>
